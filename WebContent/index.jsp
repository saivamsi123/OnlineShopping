...
<head>
<style type="text/css">
  <%@include file="templatemo_style.css" %>
</style>
        ...
        <div id="templatemo_content_left">
        	<div class="templatemo_content_left_section">
                ...
                <c:forEach items="${categoryList}" var="category">
                	<li><a href="ProductControllerDB?action=getAllProductsByCategoryId&category_id=${category.cid}">${category.ccode}-${category.cdescription}</a></li>
                </c:forEach>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <c:forEach items="${productList}" var="products" varStatus="status">
        	<div class="templatemo_product_box">
            	<h1>${products.code}  <span>(by Best Author)</span></h1>
   	      		<img src="images/templatemo_image_01.jpg" alt="image" />
                <div class="product_info">
                	<p>${products.description}</p>
                  <h3>$${products.price}</h3>
                    <div class="buy_now_button"><a href="ProductControllerDB?action=addToCart&product_id=${products.id}">Buy Now</a></div>
                    <div class="detail_button"><a href="ProductControllerDB?action=getProductById&product_id=${products.id}">Detail</a></div>
                </div>

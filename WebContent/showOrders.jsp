...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_content_right">
            ...
            <h1 style="color:white">Cart Details <span>(by author name)</span></h1>
        ...
        <table border="2">
        	<tr>
      			<td>
	      			<h1 class="alignleft">Order Id:${order.orderId}</h1>
					<br/>
					<h1 class="alignright">Order Date:${order.orderDate}</h1>
					<br/>
				</td>
				<td>
					<table border="2">
	       				<tr>
	       					<h1 class="alignleft">Customer Name:${order.username}</h1>
							<br/>
							<h1 class="alignright">Mobile Number:${order.customer.phoneNo}</h1>
						</tr>
					</table>
				</td>
			</tr>
